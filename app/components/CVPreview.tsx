...
export function CVPreview({ pdfBase64, onGenerateAgain }: Props) {
  ...
  // Clean up object URL when component unmounts or pdfBase64 changes
  useEffect(() => {
    return () => {
  ...
  return (
    <div className="flex flex-col gap-4">
      ...
      <div className="flex items-center gap-2">
        ...
        <h2 className="text-sm font-semibold text-gray-900">Your tailored CV is ready</h2>
      </div>
      ...
      <p className="text-xs text-gray-400 text-center">
        Preview may look slightly different from the downloaded PDF.
      </p>
