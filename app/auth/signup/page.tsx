      ...
      >
        ...
        <div className="relative z-10 w-full max-w-sm text-center">
          <div className="glass-card rounded-2xl p-8">
            ...
            >
              <svg className="h-6 w-6" fill="none" stroke="#6EE7B7" viewBox="0 0 24 24">
    ...
    >
      ...
      <div className="relative z-10 w-full max-w-sm">
        <div className="text-center mb-8">
          ...
          <p className="mt-1 text-sm text-white/55">Save your CV once, tailor it endlessly</p>
        </div>
        ...
        <div className="glass-card rounded-2xl p-8">
          ...
          <button
            ...
            className="btn-glass glass-card w-full rounded-xl px-4 py-2.5 text-sm font-medium text-white flex items-center justify-center gap-2.5 disabled:opacity-50 disabled:cursor-not-allowed"
          >
            <GoogleIcon />
